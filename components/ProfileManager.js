...
import { saveLeadProfile, getUserProfiles, deleteProfile } from '../lib/firestore';
...
export default function ProfileManager({ currentAnalysis, currentLeadData, analysisType }) {
  ...
  const handleSaveProfile = async () => {
    ...
    setLoading(true);
    const result = await saveLeadProfile({
      name: profileName,
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-6 mt-6">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-2xl font-semibold text-gray-800">Saved Lead Profiles</h2>
        <button
      ...
      {showSaveForm && (
        <div className="bg-blue-50 rounded-lg p-4 mb-6">
          <h3 className="font-semibold text-gray-800 mb-3">Save Current Analysis as Profile</h3>
          <div className="space-y-3">
            <div>
              ...
              <input
                ...
                placeholder="e.g., High-Priority Tech Lead"
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g., tech, high-value, follow-up"
                className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
              />
            </div>
            <button
      ...
      {loading ? (
        ...
        <div className="text-center py-8 text-gray-500">
          No saved profiles yet. Analyze a lead and save it to get started!
        </div>
      ) : (
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {profiles.map(profile => (
            <div key={profile.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
              ...
              <button
                onClick={() => {
                  // You can implement a view/edit functionality here
